...
export class HeroComponent implements OnInit, OnDestroy {
  ...
  socials = [
    { icon: 'fab fa-linkedin', url: 'https://www.linkedin.com/in/bilal-bin-kabeer-3371ba24a', label: 'LinkedIn' },
    { icon: 'fab fa-instagram', url: 'https://www.instagram.com/_bilal_18._', label: 'Instagram' },
    { icon: 'fab fa-whatsapp', url: 'https://wa.me/971542157969', label: 'WhatsApp' },
  ];
